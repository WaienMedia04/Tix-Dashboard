...
import { ArrowLeft, Flame, LogOut, Plus, Trash2, Users, X } from "lucide-react";
import {
        ...
        {vista.tipo === "lista" && (
          <div className="h-full overflow-y-auto">
            ...
            {conversaciones?.map((c) => (
              <div
                key={c.id}
                className={`flex w-full items-center gap-1 border-b border-border transition-colors hover:bg-accent ${
              ...
              >
                ...
                <button
                  ...
                  className="mr-2 flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-muted-foreground/60 transition-colors hover:bg-destructive/10 hover:text-destructive"
                >
