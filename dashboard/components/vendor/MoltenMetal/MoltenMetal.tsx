// @ts-nocheck
/* eslint-disable */
// Vendorizado de React Bits (https://reactbits.dev) — componente MoltenMetal.
// Se agregó transparent/cullFace/depthTest/depthWrite al Program (ausentes en
// la fuente original) — necesarios para un triángulo de pantalla completa 2D,
// donde el depth/cull test no aplica y sin `transparent:true` el blend de
// alpha premultiplicado del shader nunca se activa.
"use client";
