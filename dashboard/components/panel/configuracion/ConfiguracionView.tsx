...
import { CodigoAccesoCard } from "./CodigoAccesoCard";
import { ListaEmpleados } from "./ListaEmpleados";

export function ConfiguracionView() {
  const { slug, codigoAcceso, empresa } = usePanel();
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <CodigoAccesoCard codigoAcceso={codigoAcceso} />
      </div>

      <ListaEmpleados slug={slug} codigoAcceso={codigoAcceso} />
    </div>
  );
}
